...
#name-reveal .reveal-name {
  font-family: var(--sans); font-size: 3.2rem; font-weight: 700;
...
<div id="gate-overlay">
  ...
  <div id="name-reveal">
    <div class="reveal-name" id="reveal-name-text"></div>
    <div class="reveal-tagline">is about to see everything.</div>
  </div>
</div>
"""
...
(function() {
  ...
  function showBook(data) {
    ...
    function startReveal() {
      ...
      revealText.style.animation = 'pulseIn 0.8s cubic-bezier(.22,.68,.36,1.2) forwards';
